...
namespace Ambient.Environment {
    ...
    public sealed class TiltShift : PostProcessEffectSettings {
        ...
        public FloatParameter topAmount = new FloatParameter() { value = 0.1f };
        public FloatParameter bottomAmount = new FloatParameter() { value = 0.1f };
    ...
    public sealed class TiltShiftRenderer : PostProcessEffectRenderer<TiltShift> {
        ...
        private static readonly int TopAmount = Shader.PropertyToID("_TopAmount");
        private static readonly int BottomAmount = Shader.PropertyToID("_BottomAmount");
        ...
        public override void Render(PostProcessRenderContext context) {
            ...
            sheet.properties.SetFloat(TopAmount, settings.topAmount);
            sheet.properties.SetFloat(BottomAmount, settings.bottomAmount);
